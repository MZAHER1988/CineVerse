                ...
                <div className="transition-all duration-700">
                    <div className="flex flex-wrap items-center gap-4 mb-4">
                        ...
                        <div className="flex items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-yellow-400 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <span className="text-neutral-400 text-sm">Movie Release Date</span>
                        ...
                        <div className="flex flex-wrap gap-4">
                          <button className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586V7a1 1 0 10-2 0v6a1 1 0 001 1h6a1 1 0 100-2h-3.586l3.293-3.293z" clipRule="evenodd" />
                            </svg>
                            Watch Now
                          </button>
