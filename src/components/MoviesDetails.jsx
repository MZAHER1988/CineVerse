...
function MoviesDetails({ movieId, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-5xl bg-neutral-800 rounded-lg shadow-xl max-h-[90vh] overflow-y-auto overflow-hidden "
      >
        <button
          onClick={onClose}
                    ...
                    {movie.imdb_id && (
                      ...
                      >
                        ...
                        >
                          ...
                          <path d="M22.416 0H1.62C.742 0 .032.698.032 1.558v20.883c0 .86.71 1.559 1.588 1.559h20.796c.877 0 1.587-.698 1.587-1.559V1.558C24 .003.698 23.293 0 22.416 0zM7.72 13.12c0 .368-.023.62-.06.767-.046.142-.133.27-.26.37-.14.11-.297.194-.48.252-.177.053-.412.08-.697.08H4.868V8.99h1.376c.261 0 .467.027.632.07.163.045.301.113.413.204.11.09.19.203.24.34.052.134.076.313.076.531v.294c0 .253-.038.453-.12.6-.079.15-.21.27-.39.364v.01c.232.1.39.23.48.39.092.154.139.362.139.62v.702zm4.97-.005c0 .424-.11.748-.327.982-.222.233-.488.35-.806.35-.203 0-.356-.035-.48-.103-.121-.068-.217-.155-.297-.26-.071-.11-.133-.215-.156-.343-.023-.126-.04-.345-.04-.65V9.42c0-.42.077-.735.238-.955.166-.223.433-.335.793-.335.358 0 .624.112.79.335.164.22.245.535.245.954v3.695zm4.913-3.272c0 .419-.113.727-.342.918-.23.192-.56.288-.988.288h-.5v2.212h14.08V8.989h1.683c.379 0 .69.095.922.28.237.185.35.492.35.918v.656z" />
