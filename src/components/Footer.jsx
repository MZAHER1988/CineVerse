        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-4 text-sm">
              ...
              CineVerse gives you access to a vast collection of films across
              all genres.
            </p>
            <div className="flex space-x-4">
              ...
              >
                ...
                >
                  ...
                  2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 
                  6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 
                  0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 
                  5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 
              ...
              >
                ...
                >
                  ...
                  1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 
            ...
            <form className="space-y-3">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-neutral-800 border-neutral-700 text-white px-4 py-4 rounded-lg 
